...
const processVideos = [
  ["01", "Mix the system", "/media/mixing-rock-wall-.mp4", "/media/CB2CDA87-0F5A-49C1-99F2-F746B2457D44.jpeg"],
  ["02", "Cut + shape", "/media/rock-wall-install-and-cut.mp4", "/media/58F7C5F1-579D-4834-ACAF-60C67661DFF9.jpeg"],
  ["03", "Install the arch", "/media/arch-install.mp4", "/media/C2909B99-9539-4DBD-92B4-113A9C768DFB.jpeg"],
  ["04", "Scratch + grout", "/media/rockwall-scratch-and-grout-.mp4", "/media/9CB8E9F0-64C9-4ED0-9FFA-B1D1C134AB2D.jpeg"],
  ["05", "Build the texture", "/media/rock-wall-clip-one.mp4", "/media/C42AB747-D248-4AA1-940E-2F5BCE421A6C.jpeg"],
  ["06", "Detail the design", "/media/rock-wall-clip.mp4", "/media/15A9139A-9A86-477E-96ED-C1AB405C340D.jpeg"],
  ["07", "Spray + stain", "/media/rock-wall-spray-day.mp4", "/media/20244ED7-904E-4027-8036-F943E8277D5A.jpeg"],
  ["08", "Final reveal", "/media/rock-wall-final-.mp4", "/media/DEE09557-620B-4016-9D98-401F9903ABA4.jpeg"],
];
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-rock rock-one"/><div className="hero-rock rock-two"/><div className="wrap hero-grid">
      ...
      <div className="hero-card media-card"><video autoPlay muted loop playsInline preload="metadata" poster="/media/DEE09557-620B-4016-9D98-401F9903ABA4.jpeg"><source src="/media/rock-wall-final-.mp4" type="video/mp4"/></video><div className="media-shade"/><p>THE ART OF</p><div className="stone-word">ROCK</div><p className="edition">REAL PROJECT / REAL PROCESS</p></div>
    </div></section>
    ...
    <section className="transformation"><div className="wrap"><div className="section-heading"><p className="section-no">02 / THE TRANSFORMATION</p><h2>From opening<br/>to landmark.</h2></div><div className="before-after"><figure><img src="/media/0411384A-40BD-40F0-A5F4-A8D5760E1770.jpeg" alt="Plain kitchen opening before the faux rock installation"/><figcaption><span>BEFORE</span> Raw architecture</figcaption></figure><figure><img src="/media/DEE09557-620B-4016-9D98-401F9903ABA4.jpeg" alt="Completed sculpted faux rock archway around a kitchen"/><figcaption><span>AFTER</span> Hand-sculpted rock</figcaption></figure></div></div></section>
    <section className="process-reel"><div className="wrap"><div className="reel-heading"><div><p className="section-no">03 / WATCH THE BUILD</p><h2>The process,<br/>unfiltered.</h2></div><p>Tap any clip to watch the real job unfold—from the first mix to the final reveal.</p></div><div className="video-grid">{processVideos.map(([n,title,src,poster])=><article className="video-card" key={n}><video controls playsInline preload="none" poster={poster}><source src={src} type="video/mp4"/></video><div><span>{n}</span><h3>{title}</h3></div></article>)}</div></div></section>
    <section className="curriculum" id="curriculum"><div className="wrap"><div className="section-heading"><p className="section-no">04 / CURRICULUM</p><h2>Two days.<br/>The full process.</h2></div><div className="lesson-grid">{lessons.map(([n,t,c])=><article className="lesson" key={n}><span>{n}</span><h3>{t}</h3><p>{c}</p></article>)}</div></div></section>
    <section className="field-gallery"><div className="wrap"><p className="section-no">05 / IN THE FIELD</p><div className="photo-grid"><img className="tall" src="/media/58F7C5F1-579D-4834-ACAF-60C67661DFF9.jpeg" alt="Artist installing hand-cut foam stones"/><img src="/media/4008427E-8EBF-4CA5-BACC-E637CA5192D8.jpeg" alt="Wide view of the rock ledge installation"/><img src="/media/9CB8E9F0-64C9-4ED0-9FFA-B1D1C134AB2D.jpeg" alt="Close-up of sculpted stone texture"/><img src="/media/20244ED7-904E-4027-8036-F943E8277D5A.jpeg" alt="Hand staining the faux rock wall"/><img className="tall" src="/media/700CA79A-67D7-4EA7-87CC-E6CA61C83D91.jpeg" alt="Completed full rock archway with turtle detail"/></div></div></section>
    <section className="included wrap"><div><p className="section-no">06 / WHAT’S INCLUDED</p><h2>Leave ready<br/>to create.</h2><p className="muted">We provide the materials, tools, instruction, and ongoing support. You bring work clothes and the willingness to get your hands dirty.</p></div><ul>{included.map((item,i)=><li key={item}><span>{String(i+1).padStart(2,"0")}</span>{item}<b>✓</b></li>)}</ul></section>
    <section className="pricing"><div className="wrap pricing-grid"><div><p className="section-no">07 / INVESTMENT</p><h2>Build a skill<br/>that pays.</h2><p className="muted">Small-group instruction means personal guidance throughout the build. Seats are intentionally limited.</p></div><div className="price-card featured"><div className="badge">BEST PRICE</div><p>EARLY BIRD</p><strong><sup>$</sup>895</strong><small>Limited early seats</small><a href="#register">Reserve early bird →</a></div><div className="price-card"><p>REGULAR</p><strong><sup>$</sup>1,050</strong><small>Standard admission</small><a href="#register">Reserve your seat →</a></div></div></section>
    <section className="register wrap" id="register"><div className="register-copy"><p className="section-no">08 / RESERVE YOUR SEAT</p><h2>Ready to rock?</h2><p>Submit your RSVP below. Your email app will open with your details ready to send directly to K & K Services.</p><div className="payment-note"><span>ZELLE PAYMENT</span><strong>kandkservices561@gmail.com</strong><small>Include your full name + “Rock Academy” in the memo.</small></div></div><form onSubmit={register}><label>FULL NAME<input name="name" required placeholder="Your name"/></label><div className="form-row"><label>PHONE<input name="phone" required type="tel" placeholder="(555) 555-5555"/></label><label>EMAIL<input name="email" required type="email" placeholder="you@email.com"/></label></div><label>EXPERIENCE LEVEL<select name="experience" defaultValue=""><option value="" disabled>Select one</option><option>Brand new</option><option>Some construction experience</option><option>Working contractor / artist</option></select></label><button className="button primary" type="submit">Send my RSVP <span>→</span></button>{sent&&<p className="success">Your email app is opening—press Send to complete your RSVP.</p>}</form></section>
